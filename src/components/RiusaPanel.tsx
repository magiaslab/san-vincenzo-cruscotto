...
const OPTIONAL_MODULES: { area: string; cerca: string }[] = [
  {
    area: "Allerte meteo",
    cerca:
      "ALLERTA_METEO_*, /api/meteo/allerte — URL zona Protezione Civile / regione",
  },
  {
    area: "Trasporti e treni",
    cerca:
      "build-trasporti-gtfs.mjs, FS_STAZIONE_*, /api/trasporti/treni (ViaggiaTreno)",
  },
  {
    area: "DAE / Telegram",
  ...
  return (
    <section>
      <SectionIntro
        ...
        description={`Guida per duplicare lo stack su un altro comune italiano: fork del repository, checklist dei dati essenziali e cosa personalizzare in seguito. Non serve replicare ogni pannello locale di ${COMUNE_NOME}.`}
      />
...
git push -u origin main`}
          ...
          <p>
            ...
            . Copia i valori in <code>src/lib/constants.ts</code> e negli asset
            indicati.
          </p>
        ...
        <Section title="Minimo indispensabile" id="minimo">
          ...
          <ol className="list-decimal space-y-1 pl-5">
            ...
            <li>
              Smoke test: <code>curl -s localhost:3000/api/kpi</code> deve
              restituire demografia del tuo ISTAT
            </li>
        ...
        <Section title="Moduli personalizzati (opzionali)" id="moduli">
          ...
          <p>
            Non c’è l’obbligo di portare tutto a parità di {COMUNE_NOME}: un MVP
            utile è spesso “KPI nazionali + mappa + 1–2 fonti locali”.
          </p>
        </Section>
        ...
        <Section title="Cosa non fare" id="limiti">
          <ul className="list-disc space-y-2 pl-5">
            <li>
              Non aspettarti un selettore multi-comune out-of-the-box: un deploy
              resta dedicato a un ISTAT.
            </li>
            <li>
