        ...
        <div className="mx-auto max-w-3xl px-4 py-6 sm:px-6 sm:py-8">
          <nav aria-label="Breadcrumb" className="mb-2 text-sm">
            <ol className="m-0 flex list-none flex-wrap gap-1 p-0 text-[var(--pa-muted)]">
              ...
              <li aria-current="page">Come funziona</li>
            </ol>
          </nav>
          ...
          <p className="mb-8 text-[var(--pa-muted)]">
            Architettura, stack tecnologico e flusso operativo del Cruscotto{" "}
            {COMUNE_NOME}: come i dati aperti diventano la dashboard che vedi.
          </p>
          ...
          <Section title="In sintesi" id="sintesi">
            <p>
              ...
              {COMUNE_NOME} (codice ISTAT <code>{ISTAT_CODE}</code>) e li
              presenta in sezioni tematiche. La fonte principale è{" "}
              <a
                className="underline"
          ...
          <Section title="Flusso operativo" id="flusso">
            <p>
              Dal dato pubblico alla schermata: quattro passaggi, tutti lato
              server o client senza scrittura sui sistemi delle fonti.
            </p>
            ...
            <p className="text-sm text-[var(--pa-muted)]">
              Endpoint MCP AgID:{" "}
              <code className="break-all text-[var(--pa-ink)]">
                {MCP_ENDPOINT}
              </code>
            </p>
          </Section>
          ...
          <Section title="API interne" id="api">
            <p>
              Il frontend chiama solo route locali sotto{" "}
              <code>/api/*</code>. Sono proxy/cache sottili: nessuna
              persistenza proprietaria dei dataset.
            </p>
          ...
          <Section title="Sezioni del cruscotto" id="sezioni">
            <p>
              La navigazione (sidebar desktop / menu mobile) raggruppa i temi
              in tre aree. Ogni sezione è un deep-link (
              <code>#sanita</code>, <code>#infra</code>, …).
            </p>
          ...
          <Section title="Servizi opzionali" id="opzionali">
            <ul className="list-disc space-y-2 pl-5">
              <li>
                ...
                Modal; richiede{" "}
                <code>ASSISTENTE_MODAL_URL</code> in ambiente. Senza variabile,
                l&apos;assistente resta limitato alle FAQ integrate.
              </li>
              <li>
              ...
              <li>
                <strong>PWA</strong> — installabile sulla schermata Home;
                offline solo per pagine già visitate.
              </li>
              <li>
          ...
          <Section title="Limiti e trasparenza" id="limiti">
            <p>
              ...
              dell&apos;estrazione: non c&apos;è garanzia di aggiornamento in
              tempo reale su tutti i dataset. Per usi ufficiali o legali fare
              sempre riferimento alle fonti primarie. Licenze, stemma e elenco
              completo delle fonti sono in{" "}
              <Link href="/attribuzioni" className="underline">
                Attribuzioni e regole
              </Link>
              .
