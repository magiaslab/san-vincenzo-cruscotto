...
export const SEARCH_CATALOG: SearchEntry[] = [
  ...
  },
  {
    ...
    tab: "come-funziona",
    label: "Come funziona",
    hint: "Architettura, stack e fonti",
    keywords: [
      "come funziona",
      "architettura",
      "stack",
  ...
  },
  {
    ...
    tab: "riusa",
    label: "Riusa / fork",
    hint: "Fork per un altro comune",
    keywords: ["riusa", "fork", "template", "istat", "vercel", "github"],
  },
  {
    id: "attribuzioni",
    tab: "attribuzioni",
    label: "Attribuzioni e regole",
    hint: "Licenze e fonti",
    keywords: ["attribuzioni", "licenze", "credits", "regole", "osm"],
  },
  {
    id: "fonti-non-disponibili",
    tab: "fonti-non-disponibili",
    label: "Fonti non disponibili",
    hint: "Fonti cercate e non collegate",
    keywords: [
      "fonti",
      "non disponibili",
      "mancanti",
  ...
  },
  {
    ...
    tab: "economia",
    label: "Economia",
    hint: "Lavoro, redditi, imprese, OMI",
    keywords: [
      "lavoro",
      "reddito",
      "imprese",
  ...
  },
  {
    ...
    hint: "Sindaco, giunta, consiglio DAIT",
    keywords: [
      "sindaco",
      "giunta",
      "consiglio",
  ...
  },
  {
    ...
    tab: "confronto",
    label: "Confronto",
    hint: "Comuni vicini a confronto",
    keywords: [
      "confronto",
      "vicini",
      "piombino",
  ...
  },
  {
    ...
    tab: "dati",
    label: "Dati aperti",
    hint: "Catalogo fonti ed export",
    keywords: ["open data", "dataset", "csv", "json", "export", "fonti"],
  },
  {
    id: "finanza",
    tab: "finanza",
    label: "Finanza",
    hint: "SIOPE, PNRR, ANAC, IRPEF",
    keywords: [
      "finanza",
      "bilancio",
      "pnrr",
