...
export const SEARCH_CATALOG: SearchEntry[] = [
  ...
  },
  {
    ...
    hint: "Altri comuni con un cruscotto",
    keywords: [
      "esempi",
      "fork",
      "campiglia",
  ...
  },
  {
    ...
    hint: "Guida per copiare il cruscotto",
    keywords: ["riusa", "fork", "replica", "github", "vercel", "altro comune"],
  },
  {
    id: "sostieni",
    tab: "sostieni",
    label: "Supporto",
    hint: "Caffè, GitHub, segnalazioni",
    keywords: ["sostieni", "supporto", "donazione", "caffè", "buymeacoffee"],
  },
  {
    id: "come-funziona",
    tab: "come-funziona",
    label: "Come funziona",
    hint: "Fonti e domande frequenti",
    keywords: ["come funziona", "faq", "fonti", "progetto"],
  },
  {
    id: "dae-telegram",
    tab: "sanita",
